...
| `FLARE_SOLVERR_URL` | — | No | URL of a running FlareSolverr instance. Required for the 1337x scraper to bypass Cloudflare. Example: `http://flaresolverr:8191`. |
...
# Optional
FLARE_SOLVERR_URL=http://flaresolverr:8191
