...
func (p *StorageProvider) GetPornripsRecent(ctx context.Context, skip, limit int) ([]models.PornripsGroup, error) {
	return p.dbClient.GetPornripsRecent(ctx, skip, limit)
}

func (p *StorageProvider) GetPornripsByStudio(ctx context.Context, studioNorm string, skip, limit int) ([]models.PornripsGroup, error) {
	return p.dbClient.GetPornripsByStudio(ctx, studioNorm, skip, limit)
}

func (p *StorageProvider) GetPornripsByTag(ctx context.Context, tags []string, skip, limit int) ([]models.PornripsGroup, error) {
	return p.dbClient.GetPornripsByTag(ctx, tags, skip, limit)
}

func (p *StorageProvider) SearchPornrips(ctx context.Context, query string, skip, limit int) ([]models.PornripsGroup, error) {
...
func (p *StorageProvider) GetPornripsEntriesForReEnrichment(ctx context.Context, since string, enrichedBefore int64, limit int) ([]models.PornripsEntry, error) {
	return p.dbClient.GetPornripsEntriesForReEnrichment(ctx, since, enrichedBefore, limit)
}
...
func (p *StorageProvider) GetEnrichedScenesByMatchedSourcesAndIDs(ctx context.Context, source string, ids, sources []string, limit int) ([]models.EnrichedScene, error) {
	return p.dbClient.GetEnrichedScenesByMatchedSourcesAndIDs(ctx, source, ids, sources, limit)
}
...
// ─── Perverzija entries delegates ────────────────────────────────────────────

func (p *StorageProvider) UpsertPerverzijaEntry(ctx context.Context, entry models.PerverzijaEntry) error {
	return p.dbClient.UpsertPerverzijaEntry(ctx, entry)
}

func (p *StorageProvider) UpdatePerverzijaEnrichment(ctx context.Context, entry models.PerverzijaEntry) error {
	return p.dbClient.UpdatePerverzijaEnrichment(ctx, entry)
}

func (p *StorageProvider) GetPerverzijaRecent(ctx context.Context, skip, limit int) ([]models.PerverzijaEntry, error) {
	return p.dbClient.GetPerverzijaRecent(ctx, skip, limit)
}

func (p *StorageProvider) GetPerverzijaByStudio(ctx context.Context, studioNorm string, skip, limit int) ([]models.PerverzijaEntry, error) {
	return p.dbClient.GetPerverzijaByStudio(ctx, studioNorm, skip, limit)
}

func (p *StorageProvider) GetPerverzijaByTag(ctx context.Context, tagsNorm []string, skip, limit int) ([]models.PerverzijaEntry, error) {
	return p.dbClient.GetPerverzijaByTag(ctx, tagsNorm, skip, limit)
}

func (p *StorageProvider) GetPerverzijaByPerformer(ctx context.Context, performerNorm string, skip, limit int) ([]models.PerverzijaEntry, error) {
	return p.dbClient.GetPerverzijaByPerformer(ctx, performerNorm, skip, limit)
}

func (p *StorageProvider) SearchPerverzija(ctx context.Context, query string, skip, limit int) ([]models.PerverzijaEntry, error) {
	return p.dbClient.SearchPerverzija(ctx, query, skip, limit)
}

func (p *StorageProvider) GetPerverzijaEntry(ctx context.Context, slug string) (*models.PerverzijaEntry, error) {
	return p.dbClient.GetPerverzijaEntry(ctx, slug)
}

func (p *StorageProvider) GetPerverzijaMissingDetail(ctx context.Context, limit int) ([]models.PerverzijaEntry, error) {
	return p.dbClient.GetPerverzijaMissingDetail(ctx, limit)
}

func (p *StorageProvider) PerverzijaEntriesCount(ctx context.Context) (int64, error) {
	return p.dbClient.PerverzijaEntriesCount(ctx)
}

func (p *StorageProvider) GetPerverzijaTopStudios(ctx context.Context, limit int) ([]string, error) {
	return p.dbClient.GetPerverzijaTopStudios(ctx, limit)
}

func (p *StorageProvider) GetPerverzijaTopTags(ctx context.Context, limit int) ([]string, error) {
	return p.dbClient.GetPerverzijaTopTags(ctx, limit)
}

func (p *StorageProvider) GetPerverzijaTopPerformers(ctx context.Context, limit int) ([]string, error) {
	return p.dbClient.GetPerverzijaTopPerformers(ctx, limit)
}

// ─── Freepornvideos entries delegates ─────────────────────────────────────────

func (p *StorageProvider) UpsertFreepornvideosEntry(ctx context.Context, entry models.FreepornvideosEntry) error {
	return p.dbClient.UpsertFreepornvideosEntry(ctx, entry)
}

func (p *StorageProvider) UpdateFreepornvideosEnrichment(ctx context.Context, entry models.FreepornvideosEntry) error {
	return p.dbClient.UpdateFreepornvideosEnrichment(ctx, entry)
}

func (p *StorageProvider) GetFreepornvideosRecent(ctx context.Context, skip, limit int) ([]models.FreepornvideosEntry, error) {
	return p.dbClient.GetFreepornvideosRecent(ctx, skip, limit)
}

func (p *StorageProvider) GetFreepornvideosByStudio(ctx context.Context, studioNorm string, skip, limit int) ([]models.FreepornvideosEntry, error) {
	return p.dbClient.GetFreepornvideosByStudio(ctx, studioNorm, skip, limit)
}

func (p *StorageProvider) GetFreepornvideosByTag(ctx context.Context, tagsNorm []string, skip, limit int) ([]models.FreepornvideosEntry, error) {
	return p.dbClient.GetFreepornvideosByTag(ctx, tagsNorm, skip, limit)
}

func (p *StorageProvider) GetFreepornvideosByPerformer(ctx context.Context, performerNorm string, skip, limit int) ([]models.FreepornvideosEntry, error) {
	return p.dbClient.GetFreepornvideosByPerformer(ctx, performerNorm, skip, limit)
}

func (p *StorageProvider) SearchFreepornvideos(ctx context.Context, query string, skip, limit int) ([]models.FreepornvideosEntry, error) {
	return p.dbClient.SearchFreepornvideos(ctx, query, skip, limit)
}

func (p *StorageProvider) GetFreepornvideosEntry(ctx context.Context, videoID string) (*models.FreepornvideosEntry, error) {
	return p.dbClient.GetFreepornvideosEntry(ctx, videoID)
}

func (p *StorageProvider) GetFreepornvideosMissingDetail(ctx context.Context, limit int) ([]models.FreepornvideosEntry, error) {
	return p.dbClient.GetFreepornvideosMissingDetail(ctx, limit)
}

func (p *StorageProvider) FreepornvideosEntriesCount(ctx context.Context) (int64, error) {
	return p.dbClient.FreepornvideosEntriesCount(ctx)
}

func (p *StorageProvider) GetFreepornvideosTopStudios(ctx context.Context, limit int) ([]string, error) {
	return p.dbClient.GetFreepornvideosTopStudios(ctx, limit)
}

func (p *StorageProvider) GetFreepornvideosTopTags(ctx context.Context, limit int) ([]string, error) {
	return p.dbClient.GetFreepornvideosTopTags(ctx, limit)
}

func (p *StorageProvider) GetFreepornvideosTopPerformers(ctx context.Context, limit int) ([]string, error) {
	return p.dbClient.GetFreepornvideosTopPerformers(ctx, limit)
}

// ─── Yesporn entries delegates ──────────────────────────────────────────────

func (p *StorageProvider) UpsertYespornEntry(ctx context.Context, entry models.YespornEntry) error {
	return p.dbClient.UpsertYespornEntry(ctx, entry)
}

func (p *StorageProvider) UpsertYespornEntries(ctx context.Context, entries []models.YespornEntry) (int, error) {
	return p.dbClient.UpsertYespornEntries(ctx, entries)
}

func (p *StorageProvider) UpdateYespornEnrichment(ctx context.Context, entry models.YespornEntry) error {
	return p.dbClient.UpdateYespornEnrichment(ctx, entry)
}

func (p *StorageProvider) GetYespornRecent(ctx context.Context, skip, limit int) ([]models.YespornEntry, error) {
	return p.dbClient.GetYespornRecent(ctx, skip, limit)
}

func (p *StorageProvider) GetYespornByStudio(ctx context.Context, studioNorm string, skip, limit int) ([]models.YespornEntry, error) {
	return p.dbClient.GetYespornByStudio(ctx, studioNorm, skip, limit)
}

func (p *StorageProvider) GetYespornByTag(ctx context.Context, tagsNorm []string, skip, limit int) ([]models.YespornEntry, error) {
	return p.dbClient.GetYespornByTag(ctx, tagsNorm, skip, limit)
}

func (p *StorageProvider) GetYespornByPerformer(ctx context.Context, performerNorm string, skip, limit int) ([]models.YespornEntry, error) {
	return p.dbClient.GetYespornByPerformer(ctx, performerNorm, skip, limit)
}

func (p *StorageProvider) SearchYesporn(ctx context.Context, query string, skip, limit int) ([]models.YespornEntry, error) {
	return p.dbClient.SearchYesporn(ctx, query, skip, limit)
}

func (p *StorageProvider) GetYespornEntry(ctx context.Context, videoID string) (*models.YespornEntry, error) {
	return p.dbClient.GetYespornEntry(ctx, videoID)
}

func (p *StorageProvider) GetYespornMissingDetail(ctx context.Context, limit int) ([]models.YespornEntry, error) {
	return p.dbClient.GetYespornMissingDetail(ctx, limit)
}

func (p *StorageProvider) YespornEntriesCount(ctx context.Context) (int64, error) {
	return p.dbClient.YespornEntriesCount(ctx)
}

func (p *StorageProvider) GetYespornTopStudios(ctx context.Context, limit int) ([]string, error) {
	return p.dbClient.GetYespornTopStudios(ctx, limit)
}

func (p *StorageProvider) GetYespornTopTags(ctx context.Context, limit int) ([]string, error) {
	return p.dbClient.GetYespornTopTags(ctx, limit)
}

func (p *StorageProvider) GetYespornTopPerformers(ctx context.Context, limit int) ([]string, error) {
	return p.dbClient.GetYespornTopPerformers(ctx, limit)
}

// ─── Watchporn entries delegates ─────────────────────────────────────────────
// Populated by a Mac-side launchd cron (watchporn.to is TLS-blocked from prod);
// the deployed backend reads Mongo + Redis only.

func (p *StorageProvider) UpsertWatchpornEntry(ctx context.Context, entry models.WatchpornEntry) error {
	return p.dbClient.UpsertWatchpornEntry(ctx, entry)
}

func (p *StorageProvider) UpsertWatchpornEntries(ctx context.Context, entries []models.WatchpornEntry) (int, error) {
	return p.dbClient.UpsertWatchpornEntries(ctx, entries)
}

func (p *StorageProvider) UpdateWatchpornEnrichment(ctx context.Context, entry models.WatchpornEntry) error {
	return p.dbClient.UpdateWatchpornEnrichment(ctx, entry)
}

func (p *StorageProvider) GetWatchpornRecent(ctx context.Context, skip, limit int) ([]models.WatchpornEntry, error) {
	return p.dbClient.GetWatchpornRecent(ctx, skip, limit)
}

func (p *StorageProvider) GetWatchpornByStudio(ctx context.Context, studioNorm string, skip, limit int) ([]models.WatchpornEntry, error) {
	return p.dbClient.GetWatchpornByStudio(ctx, studioNorm, skip, limit)
}

func (p *StorageProvider) GetWatchpornByTag(ctx context.Context, tagsNorm []string, skip, limit int) ([]models.WatchpornEntry, error) {
	return p.dbClient.GetWatchpornByTag(ctx, tagsNorm, skip, limit)
}

func (p *StorageProvider) GetWatchpornByPerformer(ctx context.Context, performerNorm string, skip, limit int) ([]models.WatchpornEntry, error) {
	return p.dbClient.GetWatchpornByPerformer(ctx, performerNorm, skip, limit)
}

func (p *StorageProvider) SearchWatchporn(ctx context.Context, query string, skip, limit int) ([]models.WatchpornEntry, error) {
	return p.dbClient.SearchWatchporn(ctx, query, skip, limit)
}

func (p *StorageProvider) GetWatchpornEntry(ctx context.Context, videoID string) (*models.WatchpornEntry, error) {
	return p.dbClient.GetWatchpornEntry(ctx, videoID)
}

func (p *StorageProvider) GetWatchpornMissingDetail(ctx context.Context, limit int) ([]models.WatchpornEntry, error) {
	return p.dbClient.GetWatchpornMissingDetail(ctx, limit)
}

func (p *StorageProvider) WatchpornEntriesCount(ctx context.Context) (int64, error) {
	return p.dbClient.WatchpornEntriesCount(ctx)
}

func (p *StorageProvider) GetWatchpornTopStudios(ctx context.Context, limit int) ([]string, error) {
	return p.dbClient.GetWatchpornTopStudios(ctx, limit)
}

func (p *StorageProvider) GetWatchpornTopTags(ctx context.Context, limit int) ([]string, error) {
	return p.dbClient.GetWatchpornTopTags(ctx, limit)
}

func (p *StorageProvider) GetWatchpornTopPerformers(ctx context.Context, limit int) ([]string, error) {
	return p.dbClient.GetWatchpornTopPerformers(ctx, limit)
}

// ─── Porneec entries delegates ───────────────────────────────────────────────
// Populated by the deployed PorneecSync job (porneec.com is reachable from prod
// egress); the backend reads Mongo + Redis only. No Mac cron for this source.

func (p *StorageProvider) UpsertPorneecEntry(ctx context.Context, entry models.PorneecEntry) error {
	return p.dbClient.UpsertPorneecEntry(ctx, entry)
}

func (p *StorageProvider) UpdatePorneecEnrichment(ctx context.Context, entry models.PorneecEntry) error {
	return p.dbClient.UpdatePorneecEnrichment(ctx, entry)
}

func (p *StorageProvider) GetPorneecRecent(ctx context.Context, skip, limit int) ([]models.PorneecEntry, error) {
	return p.dbClient.GetPorneecRecent(ctx, skip, limit)
}

func (p *StorageProvider) GetPorneecByStudio(ctx context.Context, studioNorm string, skip, limit int) ([]models.PorneecEntry, error) {
	return p.dbClient.GetPorneecByStudio(ctx, studioNorm, skip, limit)
}

func (p *StorageProvider) GetPorneecByTag(ctx context.Context, tagsNorm []string, skip, limit int) ([]models.PorneecEntry, error) {
	return p.dbClient.GetPorneecByTag(ctx, tagsNorm, skip, limit)
}

func (p *StorageProvider) GetPorneecByPerformer(ctx context.Context, performerNorm string, skip, limit int) ([]models.PorneecEntry, error) {
	return p.dbClient.GetPorneecByPerformer(ctx, performerNorm, skip, limit)
}

func (p *StorageProvider) SearchPorneec(ctx context.Context, query string, skip, limit int) ([]models.PorneecEntry, error) {
	return p.dbClient.SearchPorneec(ctx, query, skip, limit)
}

func (p *StorageProvider) GetPorneecEntry(ctx context.Context, slug string) (*models.PorneecEntry, error) {
	return p.dbClient.GetPorneecEntry(ctx, slug)
}

func (p *StorageProvider) GetPorneecMissingDetail(ctx context.Context, limit int) ([]models.PorneecEntry, error) {
	return p.dbClient.GetPorneecMissingDetail(ctx, limit)
}

func (p *StorageProvider) PorneecEntriesCount(ctx context.Context) (int64, error) {
	return p.dbClient.PorneecEntriesCount(ctx)
}

func (p *StorageProvider) GetPorneecTopStudios(ctx context.Context, limit int) ([]string, error) {
	return p.dbClient.GetPorneecTopStudios(ctx, limit)
}

func (p *StorageProvider) GetPorneecTopTags(ctx context.Context, limit int) ([]string, error) {
	return p.dbClient.GetPorneecTopTags(ctx, limit)
}

func (p *StorageProvider) GetPorneecTopPerformers(ctx context.Context, limit int) ([]string, error) {
	return p.dbClient.GetPorneecTopPerformers(ctx, limit)
}
