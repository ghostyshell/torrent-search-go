...
type CoverImage struct {
	...
	URL        string `json:"url,omitempty"`        // resolved for UI (manual > tpdb > details)
	MimeType   string `json:"mimeType,omitempty"`
	TpdbURL    string `json:"tpdbUrl,omitempty"`    // TPDB/StashDB cover (preferred for addon)
	DetailsURL string `json:"detailsUrl,omitempty"` // description/NFO scrape cover
}
