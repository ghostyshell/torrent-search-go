...
// (piratebay,knaben_adult,bitsearch,1337x,xxxclub,pornrips), the deployed job keeps
...
func (r *Runner) EnrichedScenesSync(ctx context.Context) (map[string]interface{}, error) {
	...
	sources := splitCSV(envOr("ENRICHED_SCENES_SOURCES", "piratebay,knaben_adult,bitsearch,1337x,xxxclub,pornrips"))
...
func (r *Runner) matchSceneSource(ctx context.Context, scene models.EnrichedScene, source string) (*models.TorrentRef, bool) {
	...
	default:
		// knaben_adult / bitsearch / 1337x / xxxclub: free-text search (the scraper
