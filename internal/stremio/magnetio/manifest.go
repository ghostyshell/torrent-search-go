...
var MochOptions = []MochOption{
	...
	{ID: "ad", Name: "AllDebrid", ShortName: "AD", ConfigKey: "allDebridApiKey", CatalogFlagKey: "", HasCatalog: false},
...
func BuildManifest(cfg Config, baseURL string) map[string]interface{} {
	...
	manifest := map[string]interface{}{
		...
		"resources": []map[string]interface{}{
			...
			{"name": "catalog", "types": []string{"movie", "series"}, "idPrefixes": []string{"rd", "pm", "ad", "dl", "ed", "oc", "tb", "pu", "magnetio_similar", "tmdb"}},
			{"name": "meta", "types": []string{"movie", "series"}, "idPrefixes": []string{"rd", "pm", "ad", "dl", "ed", "oc", "tb", "pu", "tmdb"}},
		},
		"catalogs": catalogs,
