...
func seedTPB4KPornReport() models.AddonStatusReport {
	return models.AddonStatusReport{
		...
		Sources: []models.AddonSource{
			{ID: "tpb", Name: "TPB (HiddenBay)", Status: "LIVE", Detail: "4K & 1080p torrent catalogs, JAV search."},
		...
		Features: []models.AddonFeature{
			{Title: "4K & 1080p torrent catalogs", Body: "Browse ThePirateBay and HiddenBay adult releases in 4K and 1080p, with JAV title and studio search baked into Discover."},
			...
			{Title: "Stremio and Nuvio compatible", Body: "Works in Stremio on desktop, mobile, and TV. Nuvio and other Stremio-addon clients can use the same manifest URL (debrid only)."},
		},
	}
}