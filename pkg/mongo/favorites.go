...
func (c *Client) UpdateFavoriteEntryCoverImage(ctx context.Context, entryID, coverImageURL string) (bool, error) {
	res, err := c.coll("favorite_entries").UpdateOne(ctx, bson.M{"_id": entryID}, bson.M{"$set": bson.M{
...
func (c *Client) UpdateFavoriteEntryMagnetLink(ctx context.Context, entryID, magnetLink string) (bool, error) {
	res, err := c.coll("favorite_entries").UpdateOne(ctx, bson.M{"_id": entryID}, bson.M{"$set": bson.M{
